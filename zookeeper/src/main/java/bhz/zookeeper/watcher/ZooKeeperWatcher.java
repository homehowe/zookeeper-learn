...
public class ZooKeeperWatcher implements Watcher {
	...
	public static void main(String[] args) throws Exception {
		...
		//-----------------第一步: 创建父节点 /p ------------------------//
		//当前的 boolean watch操作 是让 我们上下文已经存在的watcher 监听（watch这个节点）
		//
		
		if (zkWatch.createPath(PARENT_PATH, "父节点value", true)) {
...
//			// 读取子节点(监控childNodeChange事件)
			...
			// 更新数据
			zkWatch.writeData(PARENT_PATH, "更新父节点value");


//			Thread.sleep(1000);
//			// 创建子节点  /p/c
			zkWatch.createPath(CHILDREN_PATH, "我是一个子节点", true);
